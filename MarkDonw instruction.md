...
+ Промзводим все изменения только в этой ветке
+ Отправляем эти иземенения на свой аккаунт (push)
+ В окне на Github появляется возможность оптравить pull request.